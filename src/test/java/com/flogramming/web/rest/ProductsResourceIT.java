...
class ProductsResourceIT {
    ...
    public static Products createEntity() {
        Products products = new Products().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).photo(DEFAULT_PHOTO);
        return products;
    }
    ...
    public static Products createUpdatedEntity() {
        Products products = new Products().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).photo(UPDATED_PHOTO);
        return products;
    }
    ...
    void getAllProducts() throws Exception {
        ...
        restProductsMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(products.getId())))
    ...
    void putNewProducts() throws Exception {
        ...
        updatedProducts.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).photo(UPDATED_PHOTO);
    ...
    void partialUpdateProductsWithPatch() throws Exception {
        ...
        partialUpdatedProducts.name(UPDATED_NAME).photo(UPDATED_PHOTO);
    ...
    void fullUpdateProductsWithPatch() throws Exception {
        ...
        partialUpdatedProducts.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).photo(UPDATED_PHOTO);
