...
/**
 * REST controller for managing {@link com.flogramming.domain.Projects}.
 */
@RestController
@RequestMapping("/api")
public class ProjectsResource {
    ...
    public ResponseEntity<Projects> updateProjects(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, projects.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Projects> partialUpdateProjects(
        ...
        Optional<Projects> result = projectsRepository
            ...
            .map(existingProjects -> {
                ...
                if (projects.getPhoto() != null) {
                    existingProjects.setPhoto(projects.getPhoto());
                }
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, projects.getId())
        );
    }
