...
import com.flogramming.repository.ProductsRepository;
...
/**
 * REST controller for managing {@link com.flogramming.domain.Products}.
 */
@RestController
@RequestMapping("/api")
public class ProductsResource {
    ...
    public ResponseEntity<Products> updateProducts(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, products.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Products> partialUpdateProducts(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, products.getId())
        );
    }
    ...
    public ResponseEntity<Products> getProducts(@PathVariable String id) {
